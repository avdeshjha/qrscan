...
export class Fulfillment implements Persistant {
  ...
  public getLocation(): string {
    let ffVal = this.ffData.find(d => d.type === SymbolType.QRCode && d.code === '6');
    if (ffVal == null) return null;
  ...
  public getPrice(): string {
    let ffPrice = this.ffData.find(d => d.type === SymbolType.QRCode && d.code === '$');
  ...
  public getSite(): string {
    ...
    let siteFF = this.ffData.find(d => d.type === SymbolType.QRCode && d.code === '5');
...
export class PunchData implements Persistant {
  ...
  //   let siteFF = this.fulfillment.ffData.find(d => d.type === SymbolType.QRCode && d.code === '5');
