...
int attr zxing_framing_rect_height 0x0
int attr zxing_framing_rect_width 0x0
int attr zxing_possible_result_points 0x0
int attr zxing_preview_scaling_strategy 0x0
int attr zxing_result_view 0x0
int attr zxing_scanner_layout 0x0
int attr zxing_use_texture_view 0x0
int attr zxing_viewfinder_laser 0x0
int attr zxing_viewfinder_laser_visibility 0x0
int attr zxing_viewfinder_mask 0x0
...
int color zxing_custom_possible_result_points 0x0
int color zxing_custom_result_view 0x0
int color zxing_custom_viewfinder_laser 0x0
int color zxing_custom_viewfinder_mask 0x0
int color zxing_possible_result_points 0x0
int color zxing_result_view 0x0
int color zxing_status_text 0x0
int color zxing_transparent 0x0
int color zxing_viewfinder_laser 0x0
int color zxing_viewfinder_mask 0x0
...
int id zxing_back_button 0x0
int id zxing_barcode_scanner 0x0
int id zxing_barcode_surface 0x0
int id zxing_camera_closed 0x0
int id zxing_camera_error 0x0
int id zxing_decode 0x0
int id zxing_decode_failed 0x0
int id zxing_decode_succeeded 0x0
int id zxing_possible_result_points 0x0
int id zxing_preview_failed 0x0
int id zxing_prewiew_size_ready 0x0
int id zxing_status_view 0x0
int id zxing_viewfinder_view 0x0
...
int layout zxing_barcode_scanner 0x0
int layout zxing_capture 0x0
int raw zxing_beep 0x0
...
int string app_version 0x0
int string camera_error 0x0
int string define_zxingandroidembedded 0x0
int string library_zxingandroidembedded_author 0x0
int string library_zxingandroidembedded_authorWebsite 0x0
int string library_zxingandroidembedded_isOpenSource 0x0
int string library_zxingandroidembedded_libraryDescription 0x0
int string library_zxingandroidembedded_libraryName 0x0
int string library_zxingandroidembedded_libraryVersion 0x0
int string library_zxingandroidembedded_libraryWebsite 0x0
int string library_zxingandroidembedded_licenseId 0x0
int string library_zxingandroidembedded_repositoryLink 0x0
int string ok 0x0
...
int string zxing_app_name 0x0
int string zxing_button_ok 0x0
int string zxing_msg_camera_framework_bug 0x0
int string zxing_msg_default_status 0x0
...
int style zxing_CaptureTheme 0x0
...
int[] styleable zxing_camera_preview { 0x0, 0x0, 0x0, 0x0 }
...
int[] styleable zxing_finder { 0x0, 0x0, 0x0, 0x0, 0x0 }
